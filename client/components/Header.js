...
const style = {
    ...
    button: `flex items-center bg-[#191B1F] rounded-2xl mx-2 text-[0.9rem] font-semibold cursor-pointer hover:opacity-80`,
    buttonPadding: `p-2`,
    ...
    return (
        <div className={style.wrapper}>
            ...
            <div className={style.buttonsContainer}>
                ...
                {currentAccount ? (
                    <div className={`${style.button} ${style.buttonPadding}`}>
                        <div className={`${style.buttonTextContainer} mx-2`}>
                            {username}
                        </div>
                    </div>
                ) : (
