...
const style = {
    wrapper: `h-full text-white select-none h-full w-screen flex-1 pt-14 flex items-center justify-end pb-12 overflow-auto px-8`,
    txHistoryItem: `bg-[#191a1e] rounded-lg px-4 py-2 my-2 flex flex-row`,
